...
void PassManagerBuilder::populateModulePassManager(PassManagerBase &MPM) {
  ...
  if (OptLevel > 1){
    ...
    MPM.add(createSVNPass());                 // Remove redundancies
    MPM.add(createLVNPass());                 // Remove redundancies
    // end by leon  
  }
...
void PassManagerBuilder::populateLTOPassManager(PassManagerBase &PM,
  ...
  //add by liang
  PM.add(createSVNPass()); // Remove redundancies.
  PM.add(createLVNPass()); // Remove redundancies.
  // end by liang
