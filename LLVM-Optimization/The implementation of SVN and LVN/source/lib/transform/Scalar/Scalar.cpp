...
void llvm::initializeScalarOpts(PassRegistry &Registry) {
  ...
  //--add by liang for adding lvn and svn
  initializeSVNPass(Registry);
  initializeLVNPass(Registry);
  //end liang
...
// add by liang for adding lvn and svn
void LLVMAddLVNPass(LLVMPassManagerRef PM) {
  unwrap(PM)->add(createLVNPass());
}
void LLVMAddSVNPass(LLVMPassManagerRef PM) {
  unwrap(PM)->add(createSVNPass());
}
//end by liang
