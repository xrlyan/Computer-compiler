...
//add by leon for adding SVN adn LVN
//===----------------------------------------------------------------------===//
//
// SVN - This pass performs EBB value numbering and redundant load 
// elimination cotemporaneously.
//
FunctionPass *createSVNPass();
//===----------------------------------------------------------------------===//
//
// LVN - This pass performs local value numbering and redundant load 
// elimination cotemporaneously.
//
FunctionPass *createLVNPass();
